...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            @else
                <p class="text-gray-500 text-center py-8">Aucun artisan associé</p>
            @endif
            
            <div class="mt-6">
                <a href="#" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
                    Ajouter un artisan
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="#" class="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                ...
                <h4 class="font-medium text-gray-900">Rechercher artisan</h4>
                <p class="text-sm text-gray-500">Trouver un artisan</p>
            </a>
